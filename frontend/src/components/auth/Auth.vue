<template>
    <div class="auth-content">
        <div class="auth-modal">
            ...
            <input v-if="showSignup" type="text" v-model="user.name" placeholder="Name">
            ...
            <a href @click.prevent="showSignup = !showSignup">
                <span v-if="showSignup">Are you already registered?</span>
                <span v-else>Aren't you registered? Click here</span>
            </a>
        </div>
    </div>
</template>
