        ...
        <b-form>
            ...
            <b-form-group label="Name:" label-for="article-name">
                <b-form-input id="article-name" type="text"
                            ...
                            placeholder="Enter Article Name"></b-form-input>
            </b-form-group>
            ...
            <b-form-group label="URL image:" label-for="article-imageUrl">
            ...
            <b-form-group v-if="mode == 'save'" label="Content:" label-for="article-content">
                <VueEditor v-model="article.content" placeholder="Enter the content" />
            </b-form-group>
